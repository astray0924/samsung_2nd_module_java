...
=======
			...
			// System.out.println(file.getCanonicalPath());
			String taggedDoc = Tagger_IRNLP.tagger(file.getCanonicalPath()); // file
																				// 의
																				// path를
																				// 받아서
																				// tagged
...
<<<<<<< HEAD
			  ...
			  else if(  Double.parseDouble(args[4]) > 1 || Double.parseDouble(args[5]) > 1){
				  System.out.println("Wrong score parameter! <pmi> and <co-occurrecen> have less than 1 \n ");
				  System.exit(0);			  
...
>>>>>>> argument_parsing
			...
			if (moduleOption == true)
				...
				try {
					samsung_sentiment_module.targetlist.Main.senti(
							"-targetlist", inputDirPath, outputDirPath,
